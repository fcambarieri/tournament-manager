                                ...
                                <li>
                                    ...
                                    <ul class="menu">
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="pull-left">
                                                    <img src="${request.getSession().getServletContext().getContextPath()}/img/avatar2.png" class="img-circle" alt="user image"/>
                                                </div>
                                                <h4>
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="pull-left">
                                                    <img src="${request.getSession().getServletContext().getContextPath()}/img/avatar.png" class="img-circle" alt="user image"/>
                                                </div>
                                                <h4>
                                                    Reviewers
...
<%--                                        <small>Member since Nov. 2012</small>--%>
                                ...
                                <li class="user-footer">
                                    ...
                                    <div class="pull-right">
                                        ...
                                        <mat:logout class="btn btn-default btn-flat"/>
                                    </div>
                                </li>
                            </ul>
                        </li>
